...
public class PercentageFrame extends JDialog {
    ...
    private long getTotal(List<List<Object>> FormElementLists, int certerion, int _textValues, int _areaValues){
        long radiosGroups = 0;
        long selectionGroups = 0;
        long areas = 0;
        long inputs = 0;
        long buttons = 0;
        long textIputs;
        ...
        switch (certerion){
            case 0: // All Item Types
               ...
               for(List<Object> form: FormElementLists){
                   ...
                   if(!AreaItems.isEmpty())areas ++;
                   
                   
                   // Count input items                       
                   List<String> InputItems = ((List<String>) form.get(4));
                   if(!InputItems.isEmpty())inputs ++;
                   ...
                   if (!(buttons == 0 && radiosGroups == 0 && selectionGroups == 0 && areas == 0 && inputs == 0)){                       
                   ...
                   if((areas == 0) && (inputs == 0)){
                       ...
                       textIputs = ((areas * _areaValues) + (inputs * _textValues));                                                      
                   }                                                                 
                   if(buttons == 0) buttons = 1;
                   
                   total =  (radiosGroups * selectionGroups * textIputs  * buttons); 
            ...
            case 2:  // List Items
               ...
               for(List<Object> form: FormElementLists){
                   ...
                   if (!(buttons == 0 && selectionGroups == 0)){

                   if(selectionGroups == 0) selectionGroups = 1;
                   if(buttons == 0) buttons = 1;
                   total = selectionGroups * buttons; 
            ...
            case 3:  // Radio Items
               ...
               for(List<Object> form: FormElementLists){
                   ...
                   if(!(buttons == 0 && radiosGroups == 0)){
                       
                   if(radiosGroups == 0) radiosGroups = 1;
                   if(buttons == 0) buttons = 1;
                   total = radiosGroups * buttons; 
        ...
        // Gets the total right here 
         return total;
    }
    
    
               
    public PercentageFrame(Frame parent, List<List<Object>> FormElements, int certerion, int _textValues, int _areaValues) {
        super(parent, true);
        initComponents();
        ...
        numItems = getTotal(FormElements, certerion, _textValues, _areaValues);
        TotalTestCases = 0;
        Total.setText(Long.toString(numItems));
        SubTotal.setText(Long.toString(numItems));
