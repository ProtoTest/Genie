...
public class WebSite {
    ...
    public String getAddressWithAuthorize(){
        String addressValue;
        if (this.UserName.equals("") && this.Password.equals("")){
            
                   addressValue = this.HTTP_HTTPS.toLowerCase() + "://" + this.URL;

        } else {
                   addressValue = this.HTTP_HTTPS.toLowerCase() + "://"  + this.UserName + ":" + this.Password + "@" + this.URL;
        }
         return addressValue;
    }
        ...
        for(String Line : Web){
           ...
           if (Line.startsWith("<*") && Line.endsWith("*>")){
               ...
               // Extract the Web WebID from any line. cut after 5 digit which is index word.
                ...
                this.Password  =(Line.substring((Line.indexOf("=")+1), (Line.indexOf("*>"))));
                }   
    ...
    public boolean HasChange(WebSite Web){
     if (this.WebID.equals(Web.WebID) &&
        ...
        this.UserName.equals(Web.UserName) &&
        this.Password.equals(Web.Password) &&
    ...
    public ArrayList<String> getWebtData() throws IOException{
        ...
        newWebSite.add("<* index"+this.WebID.toString()+"row UserName=" + this.UserName + "*>");
        newWebSite.add("<* index"+this.WebID.toString()+"row Password=" + this.Password + "*>");
