...
public static Result runTest(String website, String testClassDir, String ClassName, String reportDir) throws IOException { 
        
        File file = new File(testClassDir + ClassName);
        URL url;
        try {
            url = file.toURI().toURL();
            URL[] urls = {url};
            ClassLoader clazz = new URLClassLoader(urls);
            Result result = JUnitCore.runClasses(clazz.loadClass("com.prototest.TG_WEB.ui." + ClassName));
          ...
          String reportFile = reportDir + ClassName + "Results.txt";  
