...
public class PrototestTC_Web extends javax.swing.JFrame {
    ...
    public final String getTestClassDir() {
        return testClassDir;
    }

    public final void setTestClassDir(String testClassDir) {
    ...
    public PrototestTC_Web() {
        ...
        this.setLibraryDir(((new File("").getAbsolutePath()) + "/dist/lib/"));
        this.setTestClassDir(((new File("").getAbsolutePath()) + "/build/classes/com/prototest/TG_WEB/ui/"));
        
        if (!FileUtile.searchFile(this.getWorkDir())){
           FileUtile.createFolder(this.getWorkDir());
        }

        if (!FileUtile.searchFile(this.getLibraryDir())){
           FileUtile.createFolder(this.getLibraryDir());
        }

        if (!FileUtile.searchFile(this.getTestClassDir())){
           FileUtile.createFolder(this.getTestClassDir());
        }
       ...
       if (npf.UI_Action){
           try {
                ...
                FileUtile.writeToFile((this.getWorkDir()  + this.currentProject.getName() +
                    "/" + this.currentProject.getName() + ".txt" ), this.currentProject.getProjectData());
    ...
    public final void saveProject() throws IOException{
        ...
        FileUtile.removeLinesStartWithFromFile((this.currentProject.getProjectPath() +
                "/" + this.currentProject.getName() + ".txt" ), "</");
        FileUtile.removeLinesStartWithFromFile((this.currentProject.getProjectPath() +
                "/" + this.currentProject.getName() + ".txt" ), "<*");
    ...
    public final void displayProjectOnFrame(){
       if ((this.currentProject != null)){
       setTitle("ProtoTest TG 1.0 (Test Links) [ " + this.currentProject.getName() + " ]");
       ...
       Fail.setText(this.currentProject.getFail().toString());
           ...
           setTitle("ProtoTest TG 1.0 (Test Links)");
           Title.setText("");
    ...
    public final void generateTestFormItems(){
        ...
        PercentageFrame PF = new PercentageFrame(this, FormElements, FormsCoverageList.getSelectedIndex());
        PF.setVisible(true);
        if(PF.UI_Action){

        int numberOfTestcases = PF.getTotalTestCases();
        ...
        if (NSF.UI_Action){                                    
            try {
                ...
                ScriptUtile.formtemsScript(NSF.getFileName(), currentProject.getProjectPath(),fetchedweb.getAddress(), NSF.getBrowser(),
                                           NSF.getTimeOut(), FormElements,inputValues, numberOfTestcases, FormsCoverageList.getSelectedIndex());
    ...
    public final void generateAllPaths(){
        ...
        if (NSF.UI_Action){                                    
            try {
                ...
                int numScearios = ScriptUtile.multiScenarioScript(NSF.getFileName(), currentProject.getProjectPath() ,fetchedweb.getAddress(), NSF.getBrowser(), NSF.getTimeOut(), allTreePaths);
           ...
           if(specifiedPathFrame.UI_Action && specifiedPathFrame.getSelectedPath() != null){
            ...
            if (NSF.UI_Action){                                    
                try {
                    ...
                    ScriptUtile.singleScenarioScript(NSF.getFileName(), currentProject.getProjectPath() ,fetchedweb.getAddress() , NSF.getBrowser(), NSF.getTimeOut(), specifedTreePath);
    ...
    private void initComponents() {
        ...
        jLabel14.setText("#Form Items Tests:");
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel4Layout.createSequentialGroup()
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(forms, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 102, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(18, 18, 18)
                        .add(jLabel13)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        WebsitesList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "URL", "HTTP/HTTPS", "Last Run", "#Nodes", "#Links", "#Imports", "#Media", "#Forms", "#Scenarios", "Pass", "Fail"
            }
        ) {
        ...
        WebsitesList.getColumnModel().getColumn(0).setPreferredWidth(185);
        WebsitesList.getColumnModel().getColumn(1).setPreferredWidth(90);
        WebsitesList.getColumnModel().getColumn(2).setPreferredWidth(100);
        WebsitesList.getColumnModel().getColumn(3).setPreferredWidth(70);
        WebsitesList.getColumnModel().getColumn(4).setPreferredWidth(70);
        WebsitesList.getColumnModel().getColumn(5).setPreferredWidth(70);
        WebsitesList.getColumnModel().getColumn(6).setPreferredWidth(70);
        WebsitesList.getColumnModel().getColumn(7).setPreferredWidth(70);
        WebsitesList.getColumnModel().getColumn(8).setPreferredWidth(75);
        WebsitesList.getColumnModel().getColumn(9).setPreferredWidth(50);
        WebsitesList.getColumnModel().getColumn(10).setPreferredWidth(50);
   ...
   openProject();
    ...
    private void InvalidLinksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InvalidLinksActionPerformed
        ...
        if((this.currentProject == null) || (this.currentProject.getWebSites().isEmpty()) ||
           ...
           return;
            ...
            String Command = "open " + "\"" + currentProject.getProjectPath() + "/" + CurrentScript.getText().trim() + "LinkStatus.txt\"" ;            
            try {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            HierarcyProgressBar HPB = new HierarcyProgressBar(this,fetchedweb.getAddress() , "Unknown",
                ...
                if (HPB.UI_Action){
                    ...
                    if(FormElements != null) FormElements = null;
                       ...
                       // changedWeb.setNodes(FetchTreeWebSite.NodeCount(hierarcyTree));                       
                       changedWeb.setLinks(HPB.getLinks());
                       changedWeb.setImports(HPB.getImports());
                       changedWeb.setMedia(HPB.getMedia());
                       changedWeb.setForms(HPB.getFormsNum());
                       changedWeb.setNodes( HPB.getLinks() + HPB.getImports() + HPB.getMedia()  + HPB.getFormsNum());
                       ...
                       JOptionPane.showMessageDialog(null, "Feching: " + fetchedweb.getURL() + " is done successffly");
                       
                        } else {
                            
                        JOptionPane.showMessageDialog(null, "Feching: " + fetchedweb.getURL() + " is fail");                            
   ...
   if (FormsCriteria.isSelected()){ 
        ...
        if((this.currentProject == null) || (this.currentProject.getWebSites().isEmpty()) ||
           ...
           return;
            ...
            try {
                ...
                Runtime.getRuntime().exec(new String[]{"bash","-c",Command1});
                          ...
                          "ProtoTest TG- Comfirm running ...", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                            ...
                            FileUtile.copyFile(currentProject.getProjectPath()+ "/" +
                                               CurrentScript.getText().trim() + ".class", this.getTestClassDir());
                            String web = currentProject.getWebSites().get(WebsitesList.getSelectedRow()).getURL().toString(); 
                            
                            this.setState(Frame.ICONIFIED);

                            Result result = TestRunner.runTest(web, this.getTestClassDir(), CurrentScript.getText().trim(), currentProject.getProjectPath() + "/");
                            if (result != null){
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if((this.currentProject == null) || (this.currentProject.getWebSites().isEmpty()) || (WebsitesList.getSelectedRow() < 0)){
          ...
          chooser.setAcceptAllFileFilterUsed(false);
          if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION){
              String checkCompileFile = (FilenameUtils.removeExtension(currentProject.getProjectPath() + "/" + chooser.getSelectedFile().getName())) + "Compile.sh";
              String checkRunFile = (FilenameUtils.removeExtension(currentProject.getProjectPath() + "/" + chooser.getSelectedFile().getName())) + "Run.sh";
    ...
    private void TestCheckListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TestCheckListActionPerformed
        if((this.currentProject == null) || (this.currentProject.getWebSites().isEmpty()) ||
           ...
           return;
            ...
            String Command = "open " + "\"" + currentProject.getProjectPath() + "/" + CurrentScript.getText().trim() + "TestCheckList.txt\"" ;            
            try {
            Runtime.getRuntime().exec(new String[]{"bash","-c",Command});
    ...
    private void TestResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TestResultsActionPerformed
        ...
        if((this.currentProject == null) || (this.currentProject.getWebSites().isEmpty()) ||
           ...
           return;
            ...
            String Command = "open " + "\"" + currentProject.getProjectPath() + "/" + CurrentScript.getText().trim() + "Results.txt\"" ;            
            try {
            Runtime.getRuntime().exec(new String[]{"bash","-c",Command});
    ...
    private void UrlScenarioListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UrlScenarioListActionPerformed
        if((this.currentProject == null) || (this.currentProject.getWebSites().isEmpty()) ||
           ...
           return;
            ...
            String Command = "open " + "\"" + currentProject.getProjectPath() + "/" + CurrentScript.getText().trim() + "TestUrlCheckList.txt\"" ;            
            try {
            Runtime.getRuntime().exec(new String[]{"bash","-c",Command});
